                ...
                <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <jsp:include page="navbar.jsp"></jsp:include>
                        <div class="row table-responsive">
                            <h4 align=center> ...Rejected Requests...</h4>
                            <table class="table">
                                <tr>
                                    <td><b> </b></td><td><b>Req Date</b></td><td><td><b>Loc_id</b></td>
                                    <td><b>Type</b></td><td><b>View Images</b></td>
                                </tr>
                            <%  UserDao udao = new UserDao();
                                ArrayList<servicereq> reqList = new ArrayList();
                                users user = (users) session.getAttribute("user");
                                reqList = udao.getAllRejectedRequestByUserId(user.getId());
