                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        ...
                                        <form class="user" action="UserController?op=login" method="post">
                                            <div class="form-group" data-validate = "Email Id is required">
                                                <input type="email" name="emailId" class="form-control form-control-user" id="emailId" aria-describedby="emailHelp" placeholder="Enter Email Address...">
                                            </div>
                                        ...
                                        <div class="text-center">
                                            <a class="small" href="home.jsp">Go To Home</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
