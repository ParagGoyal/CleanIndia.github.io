                ...
                <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <jsp:include page="navbar.jsp"></jsp:include>
                        <div class="row table-responsive">
                            ...
                            <table class="table">
                                <tr>
                                   <td>  </td> <td><b>Req Id</b></td><td><b>Sender's Id</b></td><td><b>Sender's Name</b></td>
                                 
                                   <td><b>Location</b></td><td><b>Location Detail</b></td><td><b>Req Date</b></td>
                                
                                    <td><b>Type</b></td><td><b>Status</b></td><td><b>Action</b></td>
                                </tr>
                            <%  UserDao udao = new UserDao();
                                ArrayList<servicereq> reqList = new ArrayList();
                                reqList = udao.getAllRequest();
                            ...
                            <tr>
                               <td>  </td>
                                ...
                                <td><%=serv.getType()%></td>
                                <td><%=serv.getReqStatus()%></td>
                                <td><a href="viewDetailRequest.jsp" class="btn btn-primary">Action</a></td>                   
                            </tr>
                            <%}
                            %>
