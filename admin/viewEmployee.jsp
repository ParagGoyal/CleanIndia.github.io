                ...
                <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <jsp:include page="navbar.jsp"></jsp:include>
                        <div class="row table-responsive">
                            ...
                            <table class="table">
                                <tr>
                                    <td><b> </b></td><td><b>Employee Id</b></td><td><b>Name</b></td><td><b>Email</b></td><td><b>Mobile</b></td>
                                    <td><b>City_id</b></td><td><b>Action</b></td>
                                </tr>
                            <%  EmployeeDao edao = new EmployeeDao();
                                ArrayList<employee> empList = new ArrayList();
                                empList = edao.getAllEmployee();
                                employee empic = (employee) (session.getAttribute("emp"));
                            ...
                            <tr>
                                ...
                                <td><%=emp.getMobile()%></td> 
                                <td><%=emp.getCity_id()%></td>
                               
                              
                                <td><a href="deleteEmployee.jsp?op=deleteEmployee&id=<%=emp.getEmpId()%>&name=<%=emp.getName()%>" class="btn btn-primary">Remove</a></td>
                            </tr>
                            <%}
                            %>
