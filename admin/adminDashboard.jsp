...
<html lang="en">
    ...
    <head>
        ...
        <%
            ...
            int totalRequests = adao.getTotalRequestCount();
            int totalUsers = adao.getTotalUsers();
            int totalEmployee = edao.getTotalEmployee();
        %>
        <div id="wrapper">
                    ...
                    <div id="content">
                       <jsp:include page="navbar.jsp"></jsp:include> 
                        <div class="container-fluid">
                            ...
                            <tr>
                                <td><h4 class="h3 mb-0 text-gray-800">Total Number Of Users :   <%=totalUsers%></h4></td>
                                <td><a href="viewUsers.jsp" class="btn btn-success">View</a>
                                </td>
                            </tr>
                            <tr>
                                <td><h4 class="h3 mb-0 text-gray-800">Total Number Of Employee :   <%=totalEmployee%></h4></td>
                                <td><a href="viewEmployee.jsp" class="btn btn-success">View</a>
                                </td>
                            </tr>
