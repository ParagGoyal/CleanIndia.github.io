...
<html lang="en">
    ...
    <head>
        ...
        <%
            ...
            int totalRequests = udao.getTotalRequestCount();
                ...
                <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <jsp:include page="navbar.jsp"></jsp:include>
                        <div class="container-fluid">
                            ...
                            <table class="table">
                                <tr>
                                    <td><h2 class="h3 mb-0 text-gray-800">Total Number Of Requests :<%=totalRequests%></h2></td>
                            </tr>
                            <tr>
                                <td><h2 class="h3 mb-0 text-gray-800">Total Number Of Users : <%=totalUsers%></h2></td>
                            </tr>
